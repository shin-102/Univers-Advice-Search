...
import Logo from '../public/UniversAdvice_logo.jpg'
  ...
  return (
    <div className="flex flex-col items-center min-h-screen bg-gradient-to-b from-[#0e5ebd] to-[#0c3199] text-white p-4">
      ...
      <motion.div
        ...
        className="mb-6"
      >
        <Avatar className="w-24 h-24 bg-white rounded-full flex items-center justify-center text-[#0e5ebd] font-bold text-xl shadow-lg">
          <img src={Logo} alt="Univers Advice" className="rounded-full" />
        </Avatar>
      </motion.div>
